...
const CITIES = [
  ...
  {code:"DAL", name:"Dallas/Fort Worth", lat:32.8998, lon:-97.0403},
...
const CITIES = [
  ...
  {code:"DAL", name:"Dallas/Fort Worth", lat:32.8998, lon:-97.0403, station:"KDFW", tz:"America/Chicago"},
...
KALSHI_TEMP_SERIES_CANDIDATES = {
    ...
    "dal": {
        "name": "Dallas/Fort Worth", "station": "KDFW",
...
ACTIVE_KALSHI_TEMP_SERIES = {
    ...
    "dal": {"name": "Dallas/Fort Worth", "station": "KDFW", "tz": "America/Chicago", "high": "KXHIGHTDAL", "low": "KXLOWTDAL"},
